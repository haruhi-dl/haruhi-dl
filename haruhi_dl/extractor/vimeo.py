    ...
    _TESTS = [
        {
            ...
            'info_dict': {
                'id': '56015672',
                'ext': 'mp4',
                'title': "haruhi-dl test video - \u2605 \" ' \u5e78 / \\ \u00e4 \u21ad \U0001d550",
        ...
        },
        {
            ...
            'info_dict': {
                'id': '68375962',
                'ext': 'mp4',
                'title': 'haruhi-dl password protected test video',
            ...
            if isinstance(ee.cause, compat_HTTPError) and ee.cause.code == 403:
                ...
                if b'Because of its privacy settings, this video cannot be played here' in errmsg:
                    raise ExtractorError(
                        ...
                        'URL. Please call haruhi-dl with the URL of the page '
