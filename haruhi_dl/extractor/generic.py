...
class GenericIE(InfoExtractor):
    ...
    _TESTS = [
        ...
        # RSS feed
        {
            'url': 'http://phihag.de/2014/haruhi-dl/rss2.xml',
            'info_dict': {
                'id': 'http://phihag.de/2014/haruhi-dl/rss2.xml',
        ...
        {
            # vshare embed
            'url': 'https://haruhi-dl-demo.neocities.org/vshare.html',
    ...
    def _real_extract(self, url):
        ...
        if not parsed_url.scheme:
                    ...
                    if default_search == 'auto_warning':
                        if re.match(r'^(?:url|URL)$', url):
                            raise ExtractorError(
                                'Invalid URL:  %r . Call haruhi-dl like this:  haruhi-dl -v "https://www.youtube.com/watch?v=BaW_jenozKc"  ' % url,
                                expected=True)
                        else:
            ...
            if default_search in ('error', 'fixup_error'):
                raise ExtractorError(
                    ...
                    'Set --default-search "ytsearch" (or run  haruhi-dl "ytsearch:%s" ) to search YouTube'
        ...
        if not full_response:
            ...
            # test whether it's HTML or not). According to haruhi-dl default Accept-Encoding
        ...
        if not found:
            ...
            # be supported by haruhi-dl thus this is checked the very last (see
            # https://dev.twitter.com/cards/types/player#On_twitter.com_via_desktop_browser)
