...
class InfoExtractor(object):
    ...
    passed to the HaruhiDL. The HaruhiDL processes this
    ...
    webpage_url:    The URL to the video webpage, if given to haruhi-dl it
                    should allow to get the same result again. (It will be set
                    by HaruhiDL if it's missing)
    ...
    def _parse_f4m_formats(self, manifest, manifest_url, video_id, preference=None, f4m_id=None,
        ...
        # currently haruhi-dl cannot decode the playerVerificationChallenge as Akamai uses Adobe Alchemy
